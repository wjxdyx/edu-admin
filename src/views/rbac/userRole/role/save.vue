...
const clickSaveRouteAuthTags = async formEl => {
    if (!formEl) return
...
<template>
    <Dialog v-model="dialogVisible" width="800px">
        ...
        <el-button @click="clickSaveRouteAuthTags(FormDataRef)">保持</el-button>
    </Dialog>
</template>
